...
part of 'base_action_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BaseActionState<T>);
}
...
/// @nodoc
class $BaseActionStateCopyWith<T,$Res>  {
$BaseActionStateCopyWith(BaseActionState<T> _, $Res Function(BaseActionState<T>) __);
}


/// Adds pattern-matching-related methods to [BaseActionState].
extension BaseActionStatePatterns<T> on BaseActionState<T> {
...
class _Initial<T> implements BaseActionState<T> {
  const _Initial();
...
@override
String toString() {
  return 'BaseActionState<$T>.initial()';
}
...
class _Loading<T> implements BaseActionState<T> {
  const _Loading();
...
@override
String toString() {
  return 'BaseActionState<$T>.loading()';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $BaseActionStateCopyWith<T, $Res> {
...
class _Error<T> implements BaseActionState<T> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Error<T>&&(identical(other.message, message) || other.message == message)&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'BaseActionState<$T>.error(message: $message, code: $code)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $BaseActionStateCopyWith<T, $Res> {
