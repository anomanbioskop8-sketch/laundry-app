...
class OrderModule {
  ...
  void _useCases() {
    ...
    sl.registerLazySingleton<StreamOrderOrchestration>(
      () => StreamOrderOrchestration(
        streamOrders: sl<StreamOrders>(),
        getCustomersByIds: sl<GetCustomersByIds>(), // SessionCubit
      ),
    );
  ...
  void _cubits() {
    ...
    sl.registerFactory<OrderCubit>(
      () => OrderCubit(sl<StreamOrderOrchestration>()),
    );
    ...
    sl.registerFactory<OrderItemSelectionCubit>(
