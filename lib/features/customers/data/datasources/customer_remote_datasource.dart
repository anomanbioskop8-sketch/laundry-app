...
class CustomerRemoteDataSource extends BaseCrudRemoteDataSource<CustomerModel> {
  CustomerRemoteDataSource(super.firestore);
  ...
  /// 🔥 custom stream by company
  Stream<List<CustomerModel>> streamByCompany(String companyId) {
    return streamWhere(field: 'companyId', isEqualTo: companyId);
  }
}
