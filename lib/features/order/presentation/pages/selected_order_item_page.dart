...
import 'package:app_laundry/features/order/presentation/widgets/selected_order_item/selected_order_item_view.dart';
              ...
              child: TabBarView(
                children: [
                  ...
                  ...LaundryItemCategory.values.map(
                    (category) => SelectedOrderItemView(category: category),
                  ),
                ],
              ),
            ),

            const SelectedOrderItemSaveButton(),
          ],
        ),
      ),
    );
